...
namespace rtype {
    ...
    Entity::Entity(EntityType type, std::vector<int> positionInScreen, u_int32_t fontSize, sf::Color& textColor, uint32_t id, bool isPrint, std::string inputText, bool writablle)
    {
        this->container.event_component = nullptr;
