...
namespace rtype {
    ...
    Core::Core() : _sceneManager(new SceneManager())
    {
    }
    ...
    int Core::run(int argc, char **argv)
    {
        ...
        Entity *spaceShipe = new Entity(EntityType::MAIN_PLAYER , {500, 500},{0, 0}, {500, 500}, 1.0, "./assets/r-typesheet42.gif", "spaceship");
        ...
        eventSystem->createNewEvent("play", _sceneManager, "second", true, EventSystemType::CHANGESCENE, sf::Keyboard::Key::Escape);
        ...
        QObject::connect(timer, &QTimer::timeout, [&]() {
            ...
            while (_sceneManager->window.pollEvent(event)){
                ...
                if (event.type == sf::Event::KeyPressed && event.key.code == sf::Keyboard::Space) {
                    Entity *test = new Entity(EntityType::BULLET , {spaceShipe->container.movement_component->pos.y, spaceShipe->container.movement_component->pos.y},{0, 0}, {500, 500}, 1.0, "./assets/r-typesheet42.gif", "bullet");
